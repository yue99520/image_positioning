...
from Config import CM_PER_UNIT
...
def _real_distance(origin, pt_axis, virtual_position):
...
def find_real_position(coord: Coordinate, virtual_position):
    ...
    obj_real_x = _real_distance(origin, ptx, pto)
    obj_real_y = _real_distance(origin, pty, pto)
